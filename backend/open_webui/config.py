...
# Timestamp-aware citations for video content
ENABLE_TIMESTAMP_CITATIONS = PersistentConfig(
    "ENABLE_TIMESTAMP_CITATIONS",
    "rag.enable_timestamp_citations",
    os.environ.get("ENABLE_TIMESTAMP_CITATIONS", "True").lower() == "true",
)
